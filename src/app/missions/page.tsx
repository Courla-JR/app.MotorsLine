      ...
      <header className="bg-[#0A0A0A]/80 backdrop-blur-xl sticky top-0 z-40">
        <div className="flex items-center justify-between px-6 h-16 w-full max-w-md mx-auto">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold tracking-tighter text-white bg-clip-text bg-gradient-to-r from-[#949493] via-[#E0E0E0] to-[#949493]" style={{ fontFamily: "Inter, sans-serif" }}>
              Motors Line
            </h1>
          </div>
